        ...
        <?php while($r = $results->fetch(PDO::FETCH_ASSOC)) { ?>
           <tr>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Are you sure you want to delete this record?');" href="delete.php?id=<?php echo $r['subscriber_id'] ?>" class="btn btn-danger">Delete</a>
                </td>
           </tr> 
        <?php }?>
    </table>
